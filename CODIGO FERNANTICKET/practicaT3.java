...
public class practicaT3 {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        Tecnico tecnico2 = new Tecnico("tech","tech","tech");
                ...
                case 1: //Perfil usuario normal:
                    do {
                        ...
                        switch (opcTipoUsuario){
                            ...
                            }else System.out.println(usuario2.comprobarIncidencias());
                                break;
                            case 3:
                                if (usuarioNormal1) {
                                    if (tecnico1 != null) {
                        ...
                        switch (opcTipoUsuario){
                            ...
                            case 2:
                                ...
                                if (usuarioTecnico1){
                                    ...
                                    System.out.println("Seleccione que id quiere cerrar");
                                    op = s.nextLine();
                                    if (inci1 != null){
                    ...
                    do {
                        ...
                        switch (opcTipoUsuario){
                            ...
                            case 4:
                                ...
                                if (usuario2 != null)System.out.println(usuario2.comprobarIncidencias());
                                System.out.println("Seleccione la id que desea asignar");
                                idSeleccionada = s.nextLine();
                                System.out.println((tecnico1 != null)? tecnico1 : "No hay ningun primer tecnico");
                                System.out.println((tecnico2 != null)? tecnico2 : "No hay ningun segundo tecnico");
                                System.out.println("Seleccione el apodo del tecnico al  que desea asignar la incidencia");
                            ...
                            case 6:
                                if (tecnico1 == null && tecnico2 == null){
                                    ...
                                    System.out.println("Eliga el apodo del tecnico que desea eliminar");
                                    apodo = s.nextLine();
